  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8">
        ...
        <div class="post">
          <h2 class="post-title"><a href="blog-post.html">{{$data->judul}}</a></h2>
          <div class="post-meta">
          ...
          <a class="btn btn-warning" href="{{route('show.show',$data->judul_slug)}}">Read more</a>
        </div>
        @endforeach


        <div class="pagination-results">
          <span>Showing {{($filtercategori->count())}} News of {{($filtercategori->count())}} results</span>
          <nav aria-label="Page navigation">
            <ul class="pagination">
              <li class="page-item active"> {!! str_replace('/?', '?', $filtercategori->render()); !!}</li>
            </ul>
          </nav>
        </div>
        <!-- /.post -->
