    ...
    <div class="container">
      <div class="video-play" data-src="{{$data->link}}">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="{{$data->link}}" allowfullscreen></iframe><i class="fa fa-play"></i>
...
@endforeach
  ...
  <section class="toolbar">
    <div class="container">
      <h5><i class="fa fa-film"></i> Recent Videos <span>({{($vidio->count())}})</span></h5>
      <form method="post">
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="card card-video">
            ...
            <div class="card-block">
              <h4 class="card-title"><a href="video-post.html">{{$data->judul}}</a></h4>
              <div class="card-meta">
