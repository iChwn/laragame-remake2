...
<button class="btn btn-outline-success" data-toggle="modal" data-target="#warningModalAlertColored{{$model->id}}" type="button"> <i class="icon icon-trash-o"></i> Accept</button>
		...
		<div class="modal-content bg-warning">
			...
			<div class="modal-body">
				<div class="text-center">
					...
					<h3>Peringatan</h3>
					<p>Apakah Anda Ingin Meng Acc Berita <u>{{$model->judul}}</u>
