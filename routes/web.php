...
Route::get('/categori/{categori}', array('as' => 'showperkategori', 'uses' =>'GuestController@showperkategori'));
Route::get('/tag/{name}', array('as' => 'showpertag', 'uses' =>'GuestController@showpertag'));
Route::get('/gambar/{categori}', array('as' => 'showpergaleri', 'uses' =>'GuestController@showpergaleri'));
...
Route::group(['middleware'=>'cors'],function(){
	...
	Route::get('/contoh3/{judul_slug}','ApiController@detail');
	Route::get('/cat','ApiController@categori');
	Route::get('/contoh4/{id}','ApiController@showcategori');
});